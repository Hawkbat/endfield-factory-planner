...
/**
 * Selection utilities for box selection and entity detection
 */
 ...
 */
export function getBoxBounds(box: { start: [number, number]; end: [number, number] }): Box {
...
export function getSelectionFromBox(
    box: { start: [number, number]; end: [number, number] },
