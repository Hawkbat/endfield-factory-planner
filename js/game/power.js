 ...
 */
export function calculatePowerArea(facility) {
 ...
 */
export function updateAllFacilityPowerStates(fieldState) {
    const updatedFacilities = fieldState.facilities.map(facility => updateFacilityPoweredState(facility, fieldState));
    return {
        ...fieldState,
 ...
 */
export function calculatePowerStats(fieldState) {
    let generated = 0;
    let consumed = 0;
