...
const _jsxFileName = "E:/Projects/endfield-factory-planner/ts/contexts/copyPaste.tsx";
import { createContext, useContext, useState } from "react";
import { createCopyChanges, serializeCopyData, deserializeCopyData } from "../game/entityOperations.js";
...
export function CopyPasteProvider({ children }) {
    ...
    const { editMode, selectedIDs, setSelectedIDs, fieldState, undoStack, applyChangeOrMulti } = useEdit();
    ...
    async function handlePaste() {
        ...
        const changesToApply = changes.length === 1 ? changes : [{ type: 'multi', changes }];
    ...
    return (_jsxDEV(CopyPasteContext.Provider, { value: value, children: children }, void 0, false, { fileName: _jsxFileName, lineNumber: 173, columnNumber: 13 }, this));
}
